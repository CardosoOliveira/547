...
* Then, save a Streetmix street after making an account to generate a unique URL for your street looking something like this: `https://streetmix.net/pedro.cardoso/15/avenida-cristiano-machado'
...
<html>
  <head>
    ...
    <script src="https://unpkg.com/3dstreet@0.2.3/dist/aframe-street-component.js"></script>
  </head>  
  <body>
